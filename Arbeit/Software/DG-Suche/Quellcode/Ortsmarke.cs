...
namespace DgSuche
{
    public class Ortsmarke
    {
        ...
        public string ToXML(bool mitLink = false)
        {
            if (mitLink)
                return string.Format("<Ortsmarke Name=\"{0}\" Art=\"{1}\" Longitude=\"{2}\" Latitude=\"{3}\" KmlLink=\"{4}\" />",
                    XML_Escape_Attribute(Name), XML_Escape_Attribute(Art), XML_Escape_Attribute(Longitude), XML_Escape_Attribute(Latitude), XML_Escape_Attribute(KmlLink));
            else
                return string.Format("<Ortsmarke Name=\"{0}\" Art=\"{1}\" Longitude=\"{2}\" Latitude=\"{3}\" />",
                    XML_Escape_Attribute(Name), XML_Escape_Attribute(Art), XML_Escape_Attribute(Longitude), XML_Escape_Attribute(Latitude));
        }
        ...
        internal object ToStringKoordinaten()
        {
